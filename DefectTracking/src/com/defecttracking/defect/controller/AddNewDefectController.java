	...
	String userId=null;
		...
		public ModelAndView onSubmit(Object command) throws ServletException,UnsupportedEncodingException {
	        ...
	        try {
	            ...
	            msg.setFrom(new InternetAddress("hemanth.shiva@gmail.com", "euphern.com Admin"));
	            msg.addRecipient(Message.RecipientType.TO,
	                             new InternetAddress("hemanth.shiva@gmail.com", "Mr. User"));
	            msg.setSubject("Your Example.com account has been activated");
	            msg.setText(msgBody);
	            Transport.send(msg);

	        } catch (AddressException e) {   	System.out.println("Exception: "+e);   }
